...
export default {
    ...
    [k.MOUNTAINSTEXT]: "Unfortunately, the consequences of climate change are also clearly visible in the mountains. These lead to <strong>global glacial melting,</strong> which manifests itself in landslides and downhills.<br><br> After the melt, only barren rock deserts remain, which <strong>makes life impossible</strong> for many small animals and plants in these areas.<br><br> Since 2000, glaciers have lost an average of <strong>3%</strong> of their volume each year. In the Alps alone, according to calculations, the number of glaciers could halve in the next few years.<br><br> This phenomenon is also a source of <strong>water scarcity</strong> in these regions, bringing with it further problems.",
    [k.AIRTITLE]: "Air",
